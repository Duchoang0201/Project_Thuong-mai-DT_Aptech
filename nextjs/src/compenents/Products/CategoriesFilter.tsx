...
function CategoriesFilter() {
  ...
  const handleCategorySelect = (categoryId: any) => {
    if (selectedCategory === categoryId) {
      ...
      getMutipleFillter({ categoryId: null });
    } else {
      setSelectedCategory(categoryId); // Otherwise, select it
      getMutipleFillter({ categoryId });
    }
  };
  ...
  return (
    <div className=" flex items-center justify-center p-4 relative">
      ...
      <div
        ...
        } transform origin-top w-56 p-3 bg-white rounded-lg shadow dark:bg-gray-700 absolute mt-80 transition-opacity duration-300 ease-in-out`}
      >
